...
module relu2_Comp (
  ...
  assign relu2_activationOut_payload_value = (($signed(pulledInputs_payload_value) < $signed(8'h0)) ? 8'h0 : pulledInputs_payload_value);
...
module conv2_Comp (
  ...
  assign _zz_conv2_inputBuf_0_port_1 = pulledInputs_payload_value;
  assign _zz_conv2_wValsR_0_1 = 1'b1;
  initial begin
    $readmemb("SpinalNNTop.v_toplevel_conv2_Comp_conv2_inputBuf_0.bin",conv2_inputBuf_0);
  end
  always @(posedge clk) begin
  ...
  assign when_QLinearConvCore_l232 = (conv2_stateReg == conv2_sReceive);
  assign pulledInputs_fire = (pulledInputs_valid && pulledInputs_ready);
  assign _zz_conv2_padWriteAddrReg = (conv2_rowElemReg == 7'h6f);
  assign when_QLinearConvCore_l250 = (conv2_recvCntReg == 11'h61f);
  assign when_QLinearConvCore_l261 = (conv2_stateReg == conv2_sLoadBias);
  assign _zz_conv2_accumReg = conv2_outChReg;
  assign when_QLinearConvCore_l276 = (conv2_stateReg == conv2_sCompute);
  assign when_QLinearConvCore_l280 = (conv2_compCycleReg < 8'hc8);
  assign _zz_conv2_inAddrReg = (conv2_rowStepReg == 6'h27);
  assign when_QLinearConvCore_l293 = ((8'h01 <= conv2_compCycleReg) && (conv2_compCycleReg <= 8'hc8));
  assign when_QLinearConvCore_l301 = ((8'h02 <= conv2_compCycleReg) && (conv2_compCycleReg <= 8'hc9));
  assign when_QLinearConvCore_l312 = ((8'h03 <= conv2_compCycleReg) && (conv2_compCycleReg <= 8'hca));
  assign _zz_conv2_accumReg_1 = ($signed(conv2_accumReg) + $signed(conv2_prodReg));
  assign when_QLinearConvCore_l316 = (conv2_compCycleReg == 8'hca);
  assign when_QLinearConvCore_l325 = (conv2_stateReg == conv2_sRequant);
  assign when_QLinearConvCore_l332 = (conv2_stateReg == conv2_sRequantMul);
  ...
  assign when_QLinearConvCore_l348 = (conv2_stateReg == conv2_sRequantWait);
  assign when_QLinearConvCore_l356 = (conv2_stateReg == conv2_sRequantWait2);
  assign when_QLinearConvCore_l363 = (conv2_stateReg == conv2_sRequantWait3);
  assign _zz_conv2_reqProdReg2 = (conv2_part1Reg + conv2_part2Reg);
  assign when_QLinearConvCore_l371 = (conv2_stateReg == conv2_sRequantShift);
  assign _zz_conv2_resultReg = ($signed(_zz__zz_conv2_resultReg) + $signed(32'h0));
  assign when_QLinearConvCore_l381 = (conv2_stateReg == conv2_sEmit);
  assign conv2_activationOut_fire = (conv2_activationOut_valid && conv2_activationOut_ready);
  assign when_QLinearConvCore_l391 = (conv2_outChReg == 5'h0f);
  assign when_QLinearConvCore_l393 = (conv2_outColReg == 4'b1101);
    ...
    if(reset) begin
      ...
      if(when_QLinearConvCore_l381) begin
        if(conv2_activationOut_fire) begin
          conv2_outChReg <= (when_QLinearConvCore_l391 ? 5'h0 : _zz_conv2_outChReg);
          if(when_QLinearConvCore_l391) begin
            conv2_outColReg <= (when_QLinearConvCore_l393 ? 4'b0000 : _zz_conv2_outColReg);
            if(when_QLinearConvCore_l393) begin
              conv2_outRowReg <= (_zz_conv2_stateReg ? 4'b0000 : _zz_conv2_outRowReg);
            end
          end
          conv2_stateReg <= (((when_QLinearConvCore_l391 && when_QLinearConvCore_l393) && _zz_conv2_stateReg) ? conv2_sReceive : conv2_sLoadBias);
        end
      end
    end
  end
...
module relu1_Comp (
  ...
  assign relu1_activationOut_payload_value = (($signed(pulledInputs_payload_value) < $signed(8'h0)) ? 8'h0 : pulledInputs_payload_value);
...
module conv1_Comp (
  ...
  assign _zz_conv1_inputBuf_0_port_3 = pulledInputs_payload_value;
  assign _zz_conv1_wValsR_0_1 = 1'b1;
  initial begin
    $readmemb("SpinalNNTop.v_toplevel_conv1_Comp_conv1_inputBuf_0.bin",conv1_inputBuf_0);
  end
  always @(posedge clk) begin
